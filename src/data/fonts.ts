...
export const FONTS: FontData[] = [
  ...
  { name: '芫荽体', family: '"Iansui", cursive', fontId: 'iansui', category: 'chinese', tags: ['chinese', 'handwriting'], preview: '风华正茂' },
  { name: '注音芫荽', family: '"Bpmf Iansui", cursive', fontId: 'bpmf-iansui', category: 'chinese', tags: ['chinese', 'handwriting'], preview: '琴棋书画' },
  { name: '吉页草书', family: '"Klee One", cursive', fontId: 'klee-one', category: 'chinese', tags: ['chinese', 'handwriting'], preview: '梅兰竹菊' },
  { name: '刻石体', family: '"Chokokutai", display', fontId: 'chokokutai', category: 'chinese', tags: ['chinese', 'handwriting'], preview: '风花雪月' },
  { name: '青星体', family: '"Aoboshi One", serif', fontId: 'aoboshi-one', category: 'chinese', tags: ['chinese', 'handwriting'], preview: '春夏秋冬' },
  ...
  { name: '仙人掌古典宋', family: '"Cactus Classical Serif", serif', fontId: 'cactus-classical-serif', category: 'chinese', tags: ['chinese', 'serif'], preview: '龙飞凤舞' },
  ...
  // ===== 哥特风 / 粗犷风 (6个) =====
  { name: '德拉黑体', family: '"Dela Gothic One", sans-serif', fontId: 'dela-gothic-one', category: 'chinese', tags: ['chinese', 'gothic'], preview: '始制文字' },
  { name: '黑韩体', family: '"Black Han Sans", sans-serif', fontId: 'black-han-sans', category: 'chinese', tags: ['chinese', 'gothic'], preview: '乃服衣裳' },
  ...
  { name: '禅角黑', family: '"Zen Kaku Gothic New", sans-serif', fontId: 'zen-kaku-gothic-new', category: 'chinese', tags: ['chinese', 'gothic'], preview: '有虞陶唐' },
